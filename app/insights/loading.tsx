...
import { DailySummaryPrefetchTrigger } from '@/components/insights/daily-summary-prefetch-trigger'
...
export default function InsightsLoading() {
  return (
    <DailySummaryProvider>
      ...
      {/* Trigger daily summary prefetch immediately */}
      <DailySummaryPrefetchTrigger />
    </DailySummaryProvider>
  )
}
