...
import { Wallet, Target, Scale, Calendar, TrendingUp } from 'lucide-react'
...
const navigationItems: SectionNavigationItem[] = [
  ...
  { id: 'sustainable-spending', label: 'Sustainable Spend', labelShort: 'Sustain', icon: Scale },
...
export function InsightsNavigation() {
  return (
    <SectionNavigation
      ...
      containerClassName="grid grid-cols-2 gap-3 md:grid-cols-2 md:gap-4 lg:grid-cols-5"
    />
  )
}
