  ...
  useEffect(() => {
    async function fetchData() {
      ...
      groupMap.forEach((accts, profile) => {
        ...
        total += groupTotal
        horizonGroups.push({ profile, accounts: accts, total: groupTotal })
      })

      // Sort by total descending
      horizonGroups.sort((a, b) => b.total - a.total)

      setGroups(horizonGroups)
      setGrandTotal(total)
      setLoading(false)
    }
