# Blurb to send to family (copy below)

---

**Findash** (you’ll see it as “TS Personal Finance”) is a personal finance dashboard that pulls data from a Google Sheet and shows net worth, budgets vs actuals, spending trends, cash runway, and an AI assistant you can ask questions in plain English.

I built it over the past week while learning how AI can build real apps—not just answer questions or summarize stuff. So think of it as a work-in-progress experiment as much as a tool.
