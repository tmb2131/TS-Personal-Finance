...
export const APP_INSTRUCTIONS_EVAL_CASES: AppInstructionEvalCase[] = [
  ...
  },
  {
    ...
    expectedToolUsage: 'app_help_first',
    expectedPrimaryRoute: '/liquidity',
  },
  {
    id: 'A05',
